...
// normalizeNama() + sdm_match_item() + sdm_suggest_similar() — single source di
// admin/lib/sdm_match.php (dipakai juga oleh sdmk_kecamatan_rekap.php).
...
.sidebar-menu .menu-group{font-size:10px;font-weight:700;text-transform:uppercase;letter-spacing:1.5px;color:rgba(255,255,255,0.3);padding:14px 16px 6px}
