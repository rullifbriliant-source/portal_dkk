...
bindSVG:function(){
    ...
    obj.addEventListener("load",function(){
        ...
        svg.querySelectorAll(".district").forEach(function(item){

            item.style.cursor="pointer";

            item.addEventListener("mouseenter",function(){

                if(!item.classList.contains("district-active")){
                ...
                document.dispatchEvent(
                    ...
                    new CustomEvent(
...

                        {
                            detail:{
                                id:item.id,
                                nama:item.getAttribute("data-name") || item.id
                            }
                        }
   ...
   highlight:function(id){
    ...
    svg.querySelectorAll(".district").forEach(function(item){
        ...
        item.classList.remove("district-active");
    ...
    if(aktif){
        ...
        aktif.classList.add("district-active");
